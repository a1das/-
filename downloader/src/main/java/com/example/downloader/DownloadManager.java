...
import com.example.downloader.util.common.ApkUtil;
import com.example.downloader.util.common.FileInfoUtils;
import com.example.downloader.util.common.SdCardUtil;
import com.example.downloader.util.common.StringUtils;
import com.example.downloader.util.db.DBUtil;
import com.example.downloader.util.http.AsyncHttpClient;
import com.example.downloader.util.http.AsyncHttpResponseHandler;
import com.example.downloader.util.http.FileHttpResponseHandler;
import com.example.downloader.util.log.Logger;
import com.example.downloader.util.netstate.NetChangeObserver;
import com.example.downloader.util.netstate.NetWorkUtil;
import com.example.downloader.util.netstate.NetWorkUtil.netType;
import com.example.downloader.util.netstate.NetworkStateReceiver;
import com.example.downloader.util.notification.NotificationHelper;
...
public class DownloadManager extends Thread {
     ...
     * @return
     */
    public static DownloadManager getInstance(Context context, String dataBaseName, String downLoadPath, boolean isSaveOldData) {
    ...
    private void toRequestDownLoad() {
        ...
        if (handler.isFirstStart()) {
            Logger.d(TAG, "taskId--->" + handler.getTaskId() + ";" + handler.getUrl() + ";开始下载");
            if (mDownLoadCallback != null) {
